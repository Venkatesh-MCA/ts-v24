...
import { instid } from 'src/environments/environment';
@Component({
...
export class ScheduleComponent {
  ...
  inst_id: any;
  selectedinst: any;
  constructor(private fb: FormBuilder, private _scheduleService: ScheduleService, private route: ActivatedRoute, private _papersService: PapersService,  private router: Router) {
    ...
    console.log(this.userdata.user_info[0].user_id)
    this.inst_id = 2;
...
console.log(this.userdata[0])
    var onlinelistobj = {
      "examName": this.addscheduleform.value.examtitle,
      "examStartDateTime": m,
      "examEndDateTime": n,
      "randomQue": (this.addscheduleform.value.randomquestions == false) ? '0' : '1',
      "randomAns": '0',
      "repeatable": '0',
      "displayResult": (this.addscheduleform.value.resultdisplay == false) ? '0' : '1',
      "ipbased": this.addscheduleform.value.ipbasedexam,
      "duration": this.addscheduleform.value.duration,
      "status": '1',
      "papercode": this.addscheduleform.value.papercode,
      "ipAddress": "****",
      "userId": this.userdata.user_info[0].user_id,
      "schema": this.paper.schemaname,
      "programId": this.paper.program_id,
      "programName": this.paper.program_name,
      //"ExamID":parseInt($scope.response),
